...
namespace Demo.BehaviorTreePolice.UI
{
    public sealed class PoliceBTTreeDebugUI : MonoBehaviour
    {
        ...
        private void EnsureUI()
        {
            ...
            if (canvas == null)
            {
                GameObject canvasObject = new GameObject("Police BT Tree Debug Canvas");
            ...
            if (panelRect == null)
            {
                Transform panel = canvas.transform.Find("Police BT Tree Debug Panel");
                panelRect = panel != null ? panel.GetComponent<RectTransform>() : null;
            }

            if (panelRect == null)
            {
                GameObject panelObject = new GameObject("Police BT Tree Debug Panel");
            ...
            if (text == null)
            {
                GameObject textObject = new GameObject("Police BT Tree Debug Text");
        ...
        private Font LoadBuiltinFont()
        {
            ...
            if (font == null)
            {
                WarnMissingFont("Unity built-in font LegacyRuntime.ttf was not found. Police BT Tree Debug UI will continue without assigning a font.");
            }

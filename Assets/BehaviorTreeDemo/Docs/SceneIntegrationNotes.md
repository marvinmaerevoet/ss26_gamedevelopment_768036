...
- The root hierarchy remains unchanged because grouping would be cosmetic and could affect transform/reset assumptions.
...
For `Sheriff`, `Sheriff_01`, `Sheriff_02`, and `Sheriff_03`, verify:
...
- local `EyePoint`, lantern glow, `VisionLightCone`, and synchronized Spot Light;
